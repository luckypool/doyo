...
use Params::Validate;
use SaikinDoyo::DB::Handler::Doyo;
...
sub new {
    my $class = shift;
    my $self = {
        master => SaikinDoyo::DB::Handler::Doyo->new(role=>'m')->db,
        slave  => SaikinDoyo::DB::Handler::Doyo->new(role=>'s')->db,
    };
